...
//     - Debug:   Google's official test banner ID (safe to click freely)
//     - Release: Your real production ID (ca-app-pub-...)
//
//   AdConfig.applyRequestConfiguration() also sets testDeviceIds in debug
//   so even if a real ID slipped through, AdMob would still serve test ads.
...
abstract final class AdConfig {
  ...
  // ── Google official test IDs (debug builds) ───────────────────────────
  ...
  /// Call this once after MobileAds.instance.initialize().
  /// In debug: registers the emulator/device as a test device so AdMob
