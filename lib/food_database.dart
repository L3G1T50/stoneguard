...
const List<FoodItem> foodItems = [
  ...
  // ── FRUIT ────────────────────────────────────────────────────
  FoodItem(name: 'Apples Raw With Skin', serving: 'one', oxalateMg: 0.7, level: OxalateLevel.low, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Apples Raw Without Skin', serving: 'one', oxalateMg: 0.7, level: OxalateLevel.low, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Apples Sulfured Dried', serving: '1/4 cup', oxalateMg: 0.4, level: OxalateLevel.low, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Apricots Raw', serving: '1 fruit', oxalateMg: 0.1, level: OxalateLevel.low, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Apricots Sulfured Dried', serving: '5 halves', oxalateMg: 0.3, level: OxalateLevel.low, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Avocado', serving: '1/2 fruit', oxalateMg: 9.5, level: OxalateLevel.low, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Bananas Raw', serving: 'one', oxalateMg: 10.3, level: OxalateLevel.moderate, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Blueberries', serving: '1/2 cup', oxalateMg: 18.5, level: OxalateLevel.moderate, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Cantaloupe', serving: '1/4 melon', oxalateMg: 1.4, level: OxalateLevel.low, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Cherries Sweet Raw', serving: '1/2 cup', oxalateMg: 1.7, level: OxalateLevel.low, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Cranberries Dried Sweetened', serving: '1/4 cup', oxalateMg: 0.5, level: OxalateLevel.low, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Cranberries Raw', serving: '1 cup', oxalateMg: 0.3, level: OxalateLevel.low, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Cranberry Sauce Canned Sweetened', serving: '1/8 cup', oxalateMg: 0.4, level: OxalateLevel.low, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Dates', serving: '5 dates', oxalateMg: 25.5, level: OxalateLevel.high, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Figs Dried', serving: 'one', oxalateMg: 5.0, level: OxalateLevel.low, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Figs Raw', serving: 'one', oxalateMg: 9.3, level: OxalateLevel.low, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Grapefruit Raw', serving: '1/2 medium', oxalateMg: 13.2, level: OxalateLevel.moderate, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Grapes Red Or Green Seedless', serving: '1/2 cup', oxalateMg: 1.2, level: OxalateLevel.low, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Lemons Raw Without Peel', serving: '1/4 lemon', oxalateMg: 1.2, level: OxalateLevel.low, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Limes Raw', serving: '1/8 lime', oxalateMg: 0.7, level: OxalateLevel.low, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Mangos Raw', serving: '1/2 fruit', oxalateMg: 0.3, level: OxalateLevel.low, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Mixed Dried Fruit Prunes Apricots Pears', serving: '1/4 cup', oxalateMg: 6.1, level: OxalateLevel.low, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Nectarines Raw', serving: 'one', oxalateMg: 0.4, level: OxalateLevel.low, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Olives Canned Ripe', serving: '3 medium', oxalateMg: 5.0, level: OxalateLevel.low, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Oranges Raw', serving: 'one', oxalateMg: 23.3, level: OxalateLevel.moderate, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Papayas Raw', serving: '1/2 medium', oxalateMg: 0.5, level: OxalateLevel.low, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
  FoodItem(name: 'Peaches Canned In Heavy Syrup', serving: '1/2 cup', oxalateMg: 0.9, level: OxalateLevel.low, category: 'Fruit', tip: 'Most fruits are low oxalate. Avoid oranges and tangerines (high). Best choices: apples, peaches, watermelon, grapes.'),
